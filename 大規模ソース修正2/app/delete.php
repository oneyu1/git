...
<meta charset="UTF-8">
  ...
  <body>
    ...
    <form action="<?php echo DELETE_RESULT; ?>" method="GET"> <!--受け側はGETだがPOSTのほうがいいのか?-->
      <input type = "hidden" name="id" value = "<?php echo $result[0]["userID"] ?>">
      <input type="submit" name="YES" value="はい"style="width:120px">　<!--サイズ修正-->
    </form><br>
    <form action="<?php echo RESULT_DETAIL; ?>" method="GET">
      <input type = "hidden" name="id" value = "<?php echo $result[0]["userID"] ?>">
      <input type="submit" name="NO" value="詳細画面に戻る"style="width:120px"> <!--サイズ修正-->
    </form>
